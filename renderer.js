            ...
            return `<div class="rt-empty" style="text-align: left; align-items: flex-start; padding: 12px; gap: 10px; overflow-y: auto;">
                ...
                <div style="margin-top: 12px; border: 1px solid rgba(255,255,255,0.12); border-radius: 6px; padding: 10px; background: rgba(255,255,255,0.03); width: 100%; box-sizing: border-box;">
                    ...
                    <div style="font-size: 0.85em; font-weight: bold; opacity: 0.8; margin-bottom: 4px; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 2px;">
                        RNG <i class="fa-solid fa-circle-question interactable" style="font-size: 0.8em; opacity: 0.6; margin-left: 4px;" title="Hybrid: AI uses Tool Calls for narrative skill checks (declaring a DC first) and a pre-seeded Queue for fast combat. Legacy: AI uses only the Queue for everything."></i>
                    </div>
