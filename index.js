    ...
    const content = `
                        <div style="text-align: left; font-size: 13px; line-height: 1.5; padding-right: 8px;">
                            ...
                            <ul style="padding-left: 20px; margin-top: 0;">
                                ...
                                <li><b>Include Present NPCs in Location Scene Prompts</b> — Injects NPCs keyword-matched in the latest narrator output (Present-Now scanner, separate from Lorebook Agent active keys) plus the linked Player Character into location image prompts. Locked on while Real-Time Visualization Mode is active.</li>
